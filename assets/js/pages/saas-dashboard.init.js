var options = {
    series: [{ name: "series1", data: [31, 40, 36, 51, 49, 72, 69, 56, 68, 82, 68, 76] }],
...
chart.render();
options = { series: [56, 38, 26], chart: { type: "donut", height: 262 }, labels: ["Story A", "Story B", "Story C"], colors: ["#556ee6", "#34c38f", "#f46a6a"], legend: { show: !1 }, plotOptions: { pie: { donut: { size: "70%" } } } };
